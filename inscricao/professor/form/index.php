...
if(isset($_SESSION['id'])) {
   ...
   header('location: /teste/inscricao/professor');
}
        ...
        <section id="about">
            <div class="container">
                ...
                <header class="section-header">
                    <h3 class="mt-4">Olá <?php echo $nome;?>!</h3>
                    <p>Você está representando: <br><?php echo $instituicao;?><br>Você já enviou: <?php echo $enviados;?> desenhos.</p>
                </header>

            <div class="row justify-content-md-center">
                <div class="col col-lg-6">
                    <h4> Todos os dados preenchidos devem pertencer ao aluno! </h4>
                    <form enctype="multipart/form-data" action="../aluno/handler/index.php" method="POST" class="needs-validation" id="form-validator" novalidate>
                        ...
                        <button type="submit" class="btn btn-primary">Inscrever aluno</button>
                    </form>
